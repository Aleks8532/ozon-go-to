...
arr = [3,0,4,3,1,2,4,3,3,67,47,742,444,42,6,4,133,5,6,19,7,5,3]

pivot = calculateLocation(arr)
print("Оптимальное расстояние трубопровода от шоссе: ")
print (pivot)
